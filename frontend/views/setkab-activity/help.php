...
<li>Jika data telah lengkap diisi silahkan tekan tombol <b>UPDATE</b> <p><?= Html::img('@web/images/setkab/help/datadiri.png', ['alt' => 'datadiri-update', 'width' => 600]) ?></p>di bagian paling bawah laman</li>
    </ul>

<li>Pengisian Psikogram<p><?= Html::img('@web/images/setkab/help/psikogram.png', ['alt' => 'psikogram', 'width' => 600]) ?></p></li>
<ul>
...
<li>Anda hanya memilih radio button yang berisi nilai - nilai dari aspek psikologis yang ada, antara 1 - 7<p><?= Html::img('@web/images/setkab/help/psikogram-radio.png', ['alt' => 'psikogram-radio', 'width' => 600]) ?></p></li>
...
<li>Total skor, persentase dan kualifikasi (K2, K2, K3) akan terupdate otomatis setelah Anda menekan tombol <b>UPDATE</b></li>
    ...
    <li>Pengisian Aspek Kompetensi<p><?= Html::img('@web/images/setkab/help/kompetensi.png', ['alt' => 'kompetensi', 'width' => 600]) ?></p></li>
    <ul>
    ...
    <li>Pengisian Executive Summary<p><?= Html::img('@web/images/setkab/help/exsum.png', ['alt' => 'exsum', 'border' => 5, 'width' => 600]) ?></p></li>
    <ul>
...
<li>Pengisian Kekuatan dan Kelemahan</li>
<ul>
