...
if (Yii::$app->user->isGuest) {
    ...
    <div style='text-align:center;background-color:#F9F9F9;'><img align='center' src ='/images/front.png'></div>";
            ...
            echo '<div class="col-sm-3" style="margin-top: 3rem;"><a href="http://projects.ppsdm.com/index.php/projects/project/dashboard?id=6"><img class="img-thumbnail" src="https://upload.wikimedia.org/wikipedia/commons/d/de/Logo_of_the_Ministry_of_Health_of_the_Republic_of_Indonesia.png"><h3>Kementerian Kesehatan</h3></a></div>';
